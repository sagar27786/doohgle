...
const VenueSelection: React.FC<VenueSelectionProps> = ({ onBack }) => {
  ...
  const formatSelectedHours = () => {
    ...
    if (sorted.length === 1)
      return `${sorted[0].toString().padStart(2, "0")}:00`;
    return `${sorted[0].toString().padStart(2, "0")}:00 - ${sorted[
      sorted.length - 1
    ]
      .toString()
      .padStart(2, "0")}:00`;
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.02 }}
                    >
                      <span className="w-4 h-4 rounded bg-blue-600 text-white text-xs flex items-center justify-center">
                        ○
                      </span>
                      <span>open map</span>
                    </motion.button>
