...
const BecomeExpert: React.FC = () => {
  ...
  const expertCards = [
    {
      ...
      description:
        "When you join our platform, you're getting more than just the ability to manage your ads.",
      expandedContent:
        "Our comprehensive monetization platform offers advanced analytics, real-time reporting, and AI-powered optimization tools. Track your revenue streams, understand audience engagement, and maximize your screen's earning potential with our suite of professional tools.",
      features: [
        "Real-time Analytics",
    ...
    },
    {
      ...
      description:
        "With FRAMEN's network, you can share your captivating content with audiences across the globe.",
      expandedContent:
        "Join our global network of publishers and reach millions of viewers worldwide. Our platform provides powerful content management tools, automated scheduling, and seamless integration with major advertising networks.",
      features: [
    ...
    },
    {
      ...
      expandedContent:
        "Explore our comprehensive documentation, API references, and developer resources. Get detailed insights into our product architecture, integration guides, and best practices for maximizing your implementation.",
      features: [
        "API Documentation",
        "Integration Guides",
        "Code Examples",
    ...
    },
    {
      ...
      expandedContent:
        "Our creator program provides tools and resources to help you build engaging content, grow your audience, and monetize your creativity. Access exclusive features, get priority support, and connect with brands looking for quality content.",
      features: [
        "Content Tools",
        "Audience Growth",
        "Brand Partnerships",
  ...
  const handleButtonClick = (buttonText: string, cardIndex: number) => {
    ...
    const formType = buttonText.toLowerCase().includes("learn")
      ? "learn-more"
    ...
    window.open(
      `/form/${formType}?card=${encodeURIComponent(card.title)}`,
      "_blank"
    );
  };
