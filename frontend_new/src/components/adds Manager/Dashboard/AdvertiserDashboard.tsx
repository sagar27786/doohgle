        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
              Your campaigns are performing exceptionally well. Here's your
              personalized dashboard with real-time insights and AI-powered
              recommendations.
            </p>
        ...
        {["analytics", "audience", "billing"].includes(activeTab) && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              We're working hard to bring you amazing {activeTab} features. Stay
              tuned for updates!
            </p>
