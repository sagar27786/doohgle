...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Our network spans across various venue types including gyms, coworking spaces, retail locations, and more.",
    },
    {
      question: "Where are the screens?",
      answer:
        "Our screens are located in high-traffic venues across 32+ countries worldwide.",
    },
    {
      question: "What is different to traditional DOOH?",
      answer:
        "Unlike traditional DOOH, FRAMEN offers programmatic booking, real-time optimization, and detailed analytics.",
    },
  ];
            ...
            >
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className="w-8 h-8 bg-gray-100 dark:bg-slate-700 rounded-lg flex items-center justify-center flex-shrink-0">
                    <span className="text-gray-600 dark:text-slate-300 text-lg font-bold">
                      ?
                    </span>
                  </div>
              ...
              {openFAQ === index && (
                <div className="px-6 pb-4 pt-2">
                  <div className="ml-12 text-gray-600 dark:text-slate-300 leading-relaxed">
                    {faq.answer}
                  </div>
                </div>
              )}
