...
const CalendarScheduling: React.FC<CalendarSchedulingProps> = ({ isOpen, onClose }) => {
  ...
  const isHourSelected = useCallback((hour: number) => {
            ...
            <div className="p-8 overflow-y-auto max-h-[95vh]">
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">Select date and time slots for your campaign</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-center space-x-4">
                  <div className={`flex items-center space-x-2 px-4 py-2 rounded-full transition-all duration-300 ${
                    !selectedDate ? 'bg-purple-100 text-purple-600' : 'bg-green-100 text-green-600'
                  }`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                      !selectedDate ? 'bg-purple-500 text-white' : 'bg-green-500 text-white'
                    }`}>
                      {!selectedDate ? '1' : '✓'}
                    </div>
                  ...
                  <div className={`flex items-center space-x-2 px-4 py-2 rounded-full transition-all duration-300 ${
                    selectedHours.length === 0 ? 'bg-gray-100 text-gray-400' : 'bg-green-100 text-green-600'
                  }`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                      selectedHours.length === 0 ? 'bg-gray-300 text-white' : 'bg-green-500 text-white'
                    }`}>
                ...
                {selectedDate && (
                  ...
                  >
                    <div className="bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 rounded-3xl p-8 shadow-xl border border-purple-100/50">
                      ...
                      >
                        <div>
                          <h3 className="text-2xl font-bold text-gray-900 mb-2">Select Time Slots</h3>
                      ...
                      {selectedHours.length > 0 && (
                        ...
                        >
                          <div className="flex items-center space-x-3 mb-3">
                            ...
                            <div>
                              <span className="text-lg font-bold text-gray-900">Selected Time Slots</span>
                              <p className="text-sm text-gray-600">{selectedHours.length} hour{selectedHours.length !== 1 ? 's' : ''} selected</p>
                            </div>
                          </div>
              ...
              >
                ...
                <motion.button 
                  ...
                  `}
                  whileHover={selectedDate && selectedHours.length > 0 ? {
                    scale: 1.05,
                    boxShadow: "0 20px 40px rgba(168, 85, 247, 0.3)",
                    y: -2
                  } : {}}
                  whileTap={selectedDate && selectedHours.length > 0 ? { scale: 0.95 } : {}}
                >
                  {selectedDate && selectedHours.length > 0 && (
                    <motion.div
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 text-lg">
                  Please confirm the details below before scheduling your campaign
                </p>
              </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900">Campaign Date</h3>
