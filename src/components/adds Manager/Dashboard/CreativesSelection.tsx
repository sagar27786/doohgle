    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="w-80 bg-white border-r border-gray-200 h-screen">
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <div className="mb-4">
                <div className="text-sm text-gray-600 mb-2">Campaign setup is on 83%</div>
          ...
          <div className="flex">
            <div className="flex-1 p-6">
              <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-md font-medium text-gray-900">Landscape</h4>
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-2">
                        <span className="text-sm text-gray-600">QR Code</span>
                        <motion.button
                          onClick={() => setLandscapeQREnabled(!landscapeQREnabled)}
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-md font-medium text-gray-900">Portrait</h4>
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-2">
                        <span className="text-sm text-gray-600">QR Code</span>
                        <motion.button
                          onClick={() => setPortraitQREnabled(!portraitQREnabled)}
                          className={`relative w-12 h-6 rounded-full transition-colors duration-300 ${
              ...
              <div className="p-6">
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-900">€13.57</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-sm font-medium text-gray-900">235,581</div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    This targeting requires this budget to achieve an optimal performance: €1,490 - €3,190
                  </p>
                </div>
      ...
      <div className="fixed bottom-8 right-8">
        <motion.button
          ...
          whileHover={{ scale: 1.1, boxShadow: '0 20px 40px rgba(147, 51, 234, 0.3)' }}
          whileTap={{ scale: 0.9 }}
          animate={{
            rotate: 360,
          }}
