        ...
        <div className="grid lg:grid-cols-4 gap-8 mb-12">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">FRAMEN</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Transform your screens into revenue-generating networks with tailored content that adds value to your audience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Screen Manager</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Content Library</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">hello@framen.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-purple-600" />
                <span className="text-gray-400">+49 30 123 456 78</span>
              </div>
              <div className="flex items-center space-x-3">
