...
const ScreenCard: React.FC<{
  ...
  // Mock image/video URLs (replace with actual screen media)
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="text-center p-3 bg-blue-50 rounded-2xl">
            ...
            <p className="text-lg font-bold text-blue-700">12.5K</p>
          </div>
          ...
          <div className="text-center p-3 bg-purple-50 rounded-2xl">
            ...
            <p className="text-lg font-bold text-purple-700">6.8%</p>
          </div>
        </div>
      ...
      <motion.div
        ...
        className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-3xl blur-xl"
      />
    </motion.div>
  );
};
                    ...
                    {screens.slice(0, 4).map((screen, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">{screen.city} • Just now</p>
                        </div>
