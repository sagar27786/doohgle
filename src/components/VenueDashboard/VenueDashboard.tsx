...
const VenueDashboard: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 text-gray-900 overflow-hidden">
      ...
      <div className="pointer-events-none absolute -top-32 -left-24 h-64 w-64 rounded-full bg-purple-600/10 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-indigo-600/10 blur-3xl" />
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <aside
          ...
          } transition-all duration-300 ease-in-out bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/80 border-r border-gray-200 shadow-xl flex flex-col`}
        >
          <div className="flex items-center justify-between p-5">
            <h2
              className={`text-xl font-bold text-gray-800 tracking-tight transition-opacity duration-200 ${
              ...
              >
                <span
                  className={`shrink-0 grid place-items-center h-8 w-8 rounded-lg ${
                    showAddScreen
                      ? "bg-white/20 text-white"
                      : "bg-gray-100 text-green-600 group-hover:bg-gray-200"
                  }`}
                >
                  <FaPlus size={18} />
                </span>
        ...
        <main className="flex-1 flex flex-col">
          {/* Header */}
          <header className="sticky top-0 z-20 bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/80 border-b border-gray-200">
            <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={handleAddScreenClick}
                  className="inline-flex items-center gap-2 rounded-xl bg-purple-600 text-white px-4 py-2.5 shadow-lg hover:bg-purple-700 hover:shadow-xl transition-all active:scale-[0.98]"
                >
                  <FaPlus size={14} />{" "}
          ...
          <div className="mx-auto max-w-6xl w-full px-6 py-8 space-y-8">
            {!showAddScreen && activeTab === "screens" && (
              <section className="rounded-2xl bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/80 border border-gray-200 shadow-xl transition-all">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={handleScreenChange}
                            required
                            className="mt-1 block w-full rounded-md border border-gray-300 bg-white text-gray-900 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors"
                          >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            onChange={handleScreenChange}
                            className="mt-1 block w-full border border-gray-300 bg-white rounded-lg shadow-sm p-3 text-gray-900"
                            required
                          />
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="mt-1 block w-full border border-gray-300 bg-white rounded-lg shadow-sm p-3 text-gray-900 placeholder-gray-400"
                          />
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full text-sm text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100"
                          />
